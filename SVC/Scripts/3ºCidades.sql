/*
* Antes de executar este arquivo, mude a chave primária da tabela cidades para auto incremento off.
* Execute este script.
* Após executar este script, mude novamente para auto incremento on.
*/
use OneERP
go
