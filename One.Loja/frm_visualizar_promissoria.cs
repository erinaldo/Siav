...
namespace One.Loja
{
    ...
    public partial class frm_visualizar_promissoria : Form
    {
        VendasBLL cmd;
        Boolean baixa = false;
        ...
        public frm_visualizar_promissoria()
        {
            InitializeComponent();
        ...
        private void frm_visualizar_promissoria_MouseDoubleClick(object sender, MouseEventArgs e)
        {
        ...
        private void dataGridView1_RowPrePaint(object sender, DataGridViewRowPrePaintEventArgs e)
        {
            ...
            // String status = dgv.Rows[e.RowIndex].Cells[1].Value.ToString();
            //
            // String xx = dgv.Rows[e.RowIndex].Cells[2].Value.ToString().Split('-')[0].ToString();
            //
            // Int32 ano = Int32.Parse(dgv.Rows[e.RowIndex].Cells[2].Value.ToString().Split('/')[2].ToString().Replace("00:00:00","").Trim());
            // Int32 mes = Int32.Parse(dgv.Rows[e.RowIndex].Cells[2].Value.ToString().Split('/')[1].ToString());
            // Int32 dia = Int32.Parse(dgv.Rows[e.RowIndex].Cells[2].Value.ToString().Split('/')[0].ToString());
            //
            // DateTime dt = new DateTime(ano, mes, dia);
            // 
            //
        ...
        public void exibe_informacoes(Int32 id)
        {
        ...
        private void txt_pesquisa_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            if (this.status == Loja.status.aberto)
            {
