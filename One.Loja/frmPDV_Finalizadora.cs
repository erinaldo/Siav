...
namespace One.Loja
{
    public partial class frmPDV_Finalizadora : Form
    {
        ...
        Contexto objD = null;
        public String cpf;
        public Boolean selecionar_vendedor = false;
        ...
        public List<string> lista_troca { get; set; }
        ...
        public frmPDV_Finalizadora(Form parent)
        {
            InitializeComponent();
            //this.parent = parent;
            //this.TopLevel = false;
            this.Parent = parent;
            this.FormClosing += frmPDV_Finalizadora_FormClosing;
            ...
            //parent.Visible = false;
            //valorTroca.Text = valorTroca.ToString();


            //txtTotalGeralVendaBruto.Text = "22,00";
            //frm.txtTotalRestante.Text = txtTotalFinal.Text;
            //txtVendaID.Text = "219055";
            //objVen.codigo.ToString();
        ...
        private void frmPDV_Finalizadora_Load(object sender, EventArgs e)
        {
            ...
            {
                group_vendedor.Visible = true;
                Contexto cobjD = new Contexto();
                cobjD.PreencheComboBox(cb_vendedor,"vendedor", "id", "nome", "", "nome");
                cobjD = null;
            }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Deseja realmente fechar a venda ?", "Confirmar", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) == System.Windows.Forms.DialogResult.Yes){

                if (Encerrou != "Sim")
                {
                    //if (this.selecionar_vendedor){                        
                    //    
                    //}else
                        criarSAT();
                }
        ...
        private void _Dinheiro_TextChanged(object sender, EventArgs e)
        {
            Moeda(ref _Dinheiro);
        ...
        public void desconto()
        {
            ...
            try
            {
                this.percentual = Int32.Parse(frm.txtDescontoPer.Text);
            }
            catch
            {
                this.percentual = 0;
        ...
        private void _CartaoCredito_TextChanged(object sender, EventArgs e)
        {
        ...
        private void _CartaoDebito_TextChanged(object sender, EventArgs e)
        {
            pnlDinheiro.BackColor = Color.White;
            pnlCartaoCredito.BackColor = Color.White;
        ...
        private void _Cheque_TextChanged(object sender, EventArgs e)
        {
            pnlDinheiro.BackColor = Color.White;
            pnlCartaoCredito.BackColor = Color.White;
            pnlCartaoDebito.BackColor = Color.White;
        ...
        private void _Arrendodamento_TextChanged(object sender, EventArgs e)
        {
            pnlDinheiro.BackColor = Color.White;
            pnlCartaoCredito.BackColor = Color.White;
            pnlCartaoDebito.BackColor = Color.White;
        ...
        private void _Desconto_TextChanged(object sender, EventArgs e)
        {
            pnlDinheiro.BackColor = Color.White;
            pnlCartaoCredito.BackColor = Color.White;
            pnlCartaoDebito.BackColor = Color.White;
        ...
        private void frmPDV_Finalizadora_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                switch (e.KeyCode)
  ...
  xNome = ";
            ...
            for (int i = 0; i < tb_venda.Rows.Count; i++)
            {
                ...
                decimal quantidade_item = decimal.Parse(tb_venda.Rows[i]["vi_quantidade"].ToString());
                decimal valor_unitario = decimal.Parse(tb_venda.Rows[i]["vi_valorUnitario"].ToString());
                decimal valor_total = decimal.Parse(tb_venda.Rows[i]["vi_subtotal"].ToString());

                decimal porcentagem_aliquota = decimal.Parse(entidade.emp_tributos);
                decimal reducao_aliquota = decimal.Parse(entidade.emp_reducao);
                ...
                if (porcentagem_aliquota > 0)
                {
                    ...
                    aliquota = quantidade_item * valor_total;

                    if (totaldesconto > 0)
                    {
                        Double aux_desc = 0;

                        aliquota = aliquota - (aliquota * (this.percentual / 100));
                        //var x2 = this.percentual / 100;
                        //var x3 = aliquota * x2;
                        //valor_desconto = Convert.ToDouble(aliquota * (this.percentual / 100));

                        //if (tb_venda.Rows.Count == 1)
                        //{
                        //    
                        //   // valor_desconto = aliquota;
                        //    //aux_desc = Convert.ToDouble(totaldesconto);
                        //    //valor_desconto = Convert.ToDouble(totaldesconto);
                        //}
                        //else
                        //{
                        //    aux_desc = Convert.ToDouble((totaldesconto)) / (tb_venda.Rows.Count);
                        //     = Convert.ToDouble((totaldesconto)) / (tb_venda.Rows.Count);
                        //}
                ...
                var xx = tb_venda.Rows[i]["vi_quantidade"];
            ...
            cliente.cli_cpf = this.cpf.Replace(".", "").Replace("-", "");
            //cliente.LocalizarEmTudo(cliente.cli_cpf, "Pessoa Física");
            cliente.Localizar(cliente.cli_cpf, "cli_cpf");
            String mensagem = "";

            if (File.Exists("C:/Rede_Sistema/msg_cupom.txt"))
                mensagem += System.IO.File.ReadAllText("C:/Rede_Sistema/msg_cupom.txt");
           ...
           //     mensagem = "Cumpom impresso para o cliente " + cliente.cli_nome + ". ";
            ...
            if (valorTroca > 0)
            {
                mensagem += ";Cupom fiscal referente a troca de produto. ";
            }
            ...
            File.Delete(@"C:\Rede_Sistema\ENT.txt");
            ...
            if (codigoDeRetorno != "6000")
            {
                ...
                try
                {
                    ...
                    if (MessageBox.Show("Deseja imprimir uma segunda via do Cupom ?", "Confirmar", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) == System.Windows.Forms.DialogResult.Yes)
                    {
                        System.IO.File.WriteAllText(@"C:\Rede_Sistema\ENT.txt", xml);
                    }
                    ...
                    lblStatus.Text = "Pagamento Efetuado com sucesso !";
                    SystemSounds.Asterisk.Play();

                    String nsat = "";
                    try
                    {
                        int index = xmlpuro.IndexOf("<cNF>") + 5;
                        int index_end = xmlpuro.IndexOf("</cNF>");
                    ...
                    catch
                    {
                        ...
                        nsat = (int.Parse(nodeList[0]["cNF"].InnerText)).ToString();
                    }
                    try
                    {
                    ...
                    for (int i = 0; i < tb_venda.Rows.Count; i++)
                    {
                        ProdutosBLL prod = new ProdutosBLL();
                        prod.pro_codigo = Convert.ToInt32(tb_venda.Rows[i]["pro_codigo"]);
                        prod.localizar("pro_codigo", prod.pro_codigo.ToString());

                        String aux_string = tb_venda.Rows[i]["vi_quantidade"].ToString().Replace(',', '.');
                        Int32 aux_int = Int32.Parse(aux_string.Split('.')[0]);

                        aux_int = Convert.ToInt32(prod.pro_quantidade) - aux_int;
                        prod.pro_quantidade = aux_int;
                        prod.alterarQuantidade();
                    }
                    ...
                    if (valorTroca > 0)
                    {
                        try
                        {
                            foreach (var item in lista_troca){

                                String id_prod = item.Split('|')[0].ToString();
                                Int32 qtd_prod = Int32.Parse(item.Split('|')[1].ToString());

                                ProdutosBLL prod = new ProdutosBLL();
                                prod.pro_codigo = Convert.ToInt32(id_prod);
                                prod.localizar("pro_codigo", prod.pro_codigo.ToString());

                                qtd_prod = Convert.ToInt32(prod.pro_quantidade) + qtd_prod;
                                prod.pro_quantidade = qtd_prod;
                                prod.alterarQuantidade();
                    ...
                    if (group_vendedor.Visible)
                    {

                        Contexto objD = new Contexto();
                        SqlCommand cmd = new SqlCommand();
                        cmd.CommandText = "update Vendas set ven_vendedor = " + cb_vendedor.SelectedValue + " where ven_codigo = " + this.txtVendaID.ToString();
        ...
        private void frmPDV_Finalizadora_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                Parent.Visible = true;
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Deseja realmente fechar a venda como promissória ?", "Confirmar", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) == System.Windows.Forms.DialogResult.Yes)
            {
                ...
                frm_visualizar_promissoria_add cmd = new frm_visualizar_promissoria_add(int.Parse(this.txtVendaID.ToString()));
                cmd.ShowDialog();
        ...
        private void _Arrendodamento_KeyDown(object sender, KeyEventArgs e)
        {
         try
            {
                switch (e.KeyCode)
        ...
        private void _Desconto_KeyDown(object sender, KeyEventArgs e)
        {
             try
            {
                switch (e.KeyCode)
